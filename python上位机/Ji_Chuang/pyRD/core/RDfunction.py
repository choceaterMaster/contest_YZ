...
class RD:
    ...
    def AnalogOutNodeDataSet(self,ch=0,node=RDAnalogOutNodeCarrier,data=[]):
        ...
        return self.dll.RDAnalogOutNodeDataSet(self.handle,c_int(ch),c_int(node),byref(arr),size)
    ...
    def DigitalSPIRx(self,size=255):
        ...
        return self.dll.RDDigitalSPItRx(self.handle, byref(self.SPIdata),c_int(size),byref(self.SPIbacksize),byref(fParity))
